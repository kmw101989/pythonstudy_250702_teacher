...
SELECT * FROM customers; 
EXPLAIN SELECT * FROM customers; # ALL 394

EXPLAIN SELECT * FROM customers WHERE id = 394; # const 1

EXPLAIN SELECT * FROM customers WHERE email = 'user95976@test.com'; # ref 1
