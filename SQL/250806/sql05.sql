...
# 필름 테이블에서 영화개봉 년도가 2006년 또는 2007년이고, 영화등급이
# PG 또는 G등급인 영화의 제목만 출력해주세요!!!
...
# GROUP BY -> 집계함수를 사용해서 들어오면, 해당 컬럼값이 실제 그룹핑과 관계가 없더라도
# 출력값으로 허용 (*예외조항)

/*
film 테이블에서 rating으로 그룹을 묶어서 각 등급별 영화 갯수와 각 등급별 평균 렌탈비용을
출력하는데, 평균 렌탈비용이 높은 순으로 출력해주세요!!!
*/
