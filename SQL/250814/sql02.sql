...
# film 테이블에서 rating이 "PG-13"등급인 영화들의 description의 길이가
# rating이 "PG-13"등급인 영화들의 평균 description 길이보다
# 긴 영화의 제목을 찾아주세요.
...
# 해당 결제 내역에 대해서 각 고객별 총 결제 금액과 평균 결제 금액을 소수점 둘째 자리에서
# 반올림하여 출력하세요.
...
# actor와 film_actor 테이블을 JOIN하고 "Sci-Fi" 카테고리에 속한 영화에
...
SELECT
	*
FROM film_actor
LIMIT 5; # actor_id & # film_id

SELECT
	*
FROM film_category
LIMIT 5; # film_id & # category_id
